...
setup(
    ...
    author_email="sebastian.herold@immobilienscout24.de, maximilien.riehl@immobilienscout24.de, eric.ihrke@immobilienscout24.de",
    ...
    url="https://github.com/ImmobilienScout24/yum-repo-client",
